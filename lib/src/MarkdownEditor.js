...
const FOREGROUND_COLOR = 'transparent'; //'rgba(82, 194, 175, 1)';
const styles = StyleSheet.create({
  ...
  preview: {
    ...
    // padding: 5,
    borderWidth: 1,
    borderColor: 'grey' //FOREGROUND_COLOR,
  },
  screen: {
    flex: 1,
    flexDirection: 'column',
    ...
    return (
      <View style={styles.preview}>
        <ScrollView removeClippedSubviews>
          {this.props.previewRenderer ? this.props.previewRenderer(this.getState) : <MarkdownView styles={markdownStyles}>
    ...
    return (
      <WrapperView behavior="padding" style={styles.screen}>
        <TextInput
          ...
          value={text || this.props.defaultValue}
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            <Image
              style={[styles.button, { tintColor: 'black', padding: 8 }]}
